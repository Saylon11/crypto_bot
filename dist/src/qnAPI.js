...
if (!rawQuickNodeUrl || typeof rawQuickNodeUrl !== "string") {
    throw new Error("🚨 QUICKNODE_RPC_URL is missing or not a string in your .env file.");
}
...
if (!exports.WALLET_SECRET_KEY || typeof exports.WALLET_SECRET_KEY !== "string") {
    throw new Error("🚨 WALLET_SECRET is missing or not a string in your .env file.");
}
